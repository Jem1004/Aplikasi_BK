...
type StudentViolationViewProps = {
  violations: Violation[];
  studentName: string;
};

export function StudentViolationView({
  violations,
  studentName,
}: StudentViolationViewProps) {
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className={cn(
              "text-3xl font-bold",
              summary.totalPoints > 50 ? "text-red-600" : "text-gray-900"
            )}>
              {summary.totalPoints}
            </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Menampilkan {filteredViolations.length} dari {violations.length} data (Hanya Baca)
              </CardDescription>
            </div>
