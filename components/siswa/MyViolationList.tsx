...
type MyViolationListProps = {
  violations: Violation[];
};

export function MyViolationList({ violations }: MyViolationListProps) {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Menampilkan {filteredViolations.length} dari {violations.length} data (Read-only)
          </CardDescription>
        </CardHeader>
        <CardContent>
