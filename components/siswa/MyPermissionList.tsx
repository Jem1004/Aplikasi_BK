...
type MyPermissionListProps = {
  permissions: Permission[];
};

export function MyPermissionList({ permissions }: MyPermissionListProps) {
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Total izin yang dikeluarkan untuk Anda
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Menampilkan {filteredPermissions.length} dari {permissions.length} data (Read-only)
          </CardDescription>
        </CardHeader>
        <CardContent>
